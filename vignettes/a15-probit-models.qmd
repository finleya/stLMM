---
title: "Probit models with stLMM"
subtitle: "Binary mixed models, Albert-Chib augmentation, and prediction"
...
The probit sampler uses the Albert-Chib latent-normal representation [@AlbertChib1993]. Introduce a latent utility
...
fit <- stLMM(
  ...
  starting = list(ar1_1 = list(sigma_sq = 0.7, phi = 0.7)),
  tuning = list(ar1_1 = list(sigma_sq = 0.08, phi = 0.12)),
  n_samples = 900,
  verbose = FALSE
)
