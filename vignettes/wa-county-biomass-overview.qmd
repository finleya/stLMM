...
Each vignette in the series is reproducible from its Quarto source or extracted R code. Those source links appear near the top of each article. The shared Washington biomass data bundle is linked from each article and is the only data download needed for the series.
