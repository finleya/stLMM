...
The unit-response models are BHF-style unit-level SAE models [@BatteseHarterFuller1988]. The series starts with BHF models that use row-level TCC, county random effects, and a shared year effect, then moves to two-stage county-time CAR models, FIA-unit-specific residual variances, and continuous space-time prediction.
